...
public class ReactKSYVideoViewManager extends SimpleViewManager<ReactKSYVideoView> {
    ...
    private static final int COMMAND_RELOADVIDEOSOURCE_ID = 2;
    private static final String COMMAND_RELOADVIDEOSOURCE_NAME = "reloadVideoSource";
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(
                COMMAND_SAVEBITMAP_NAME, COMMAND_SAVEBITMAP_ID, COMMAND_RELOADVIDEOSOURCE_NAME, COMMAND_RELOADVIDEOSOURCE_ID
        );
    }
    ...
    public void receiveCommand(ReactKSYVideoView video, int commandId, @Nullable ReadableArray args) {
        switch (commandId){
            case COMMAND_SAVEBITMAP_ID:
                video.saveBitmap();
                break;
            case COMMAND_RELOADVIDEOSOURCE_ID:
                video.reload(args.getMap(0).getString(PROP_SRC_URI));
                break;
            default:
                break;
        }
